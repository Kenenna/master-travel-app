...
const services = [
  { tag: "Airport & Terminal", title: "Airport Transfers", body: "Seamless door-to-terminal service with flight monitoring and meet-and-greet. Stress-free travel begins the moment you land.", image: airportImg },
  { tag: "Premium Fleet", title: "Luxury Transport", body: "A curated fleet of prestige vehicles delivers an unrivalled travel experience, whether for city journeys or long-distance trips.", image: heroCar },
  { tag: "Business Travel", title: "Corporate & Business", body: "Premier transportation for executives and teams — punctual, professional, and tailored to your corporate schedule.", image: corporateImg },
  { tag: "Special Occasions", title: "Luxury Wedding Transport", body: "Make your most cherished day unforgettable. Impeccably presented vehicles and discreet, seamless service for the entire wedding party.", image: weddingImg },
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[92vh] w-full overflow-hidden">
        <img src={heroCar} alt="Luxury chauffeur car outside a stately estate" width={1920} height={1200} className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-[1400px] flex-col items-center justify-center px-6 text-center">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <Link to="/special-services" className="btn-gold">Special Services</Link>
            <Link to="/book" className="btn-gold">Book A Ride</Link>
            <Link to="/book" className="btn-gold">Book A Delivery</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="mt-6 font-serif text-4xl md:text-5xl">Every journey, distinguished.</h2>
          ...
          <Link to="/contact" className="btn-gold mt-10">Contact Us</Link>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1200px] gap-12 px-6 md:grid-cols-[280px_1fr] md:items-center">
          <div className="mx-auto flex h-64 w-64 items-center justify-center rounded-full border border-[var(--gold)]/40 md:mx-0">
            <div className="text-center">
              <div className="font-serif text-xs tracking-[0.4em]" style={{ color: "var(--gold)" }}>PRESTIGE</div>
              <div className="mt-2 font-serif text-5xl" style={{ color: "var(--gold)" }}>2025<span className="text-white/60">/</span>26</div>
            ...
            {services.map((s) => (
              <article key={s.title} className="group">
                <div className="relative overflow-hidden">
                  <img src={s.image} alt={s.title} loading="lazy" width={1200} height={900} className="h-[320px] w-full object-cover transition-transform duration-700 group-hover:scale-105 md:h-[380px]" />
                  <div className="absolute inset-0 bg-black/25 transition-opacity duration-500 group-hover:bg-black/15" />
                  <div className="absolute left-0 right-0 top-6 text-center text-[0.65rem] tracking-[0.35em] uppercase text-white/85">{s.tag}</div>
                </div>
                <div className="pt-6">
                  ...
                  <Link to="/services" className="mt-6 inline-flex items-center gap-3 text-[0.72rem] font-medium uppercase tracking-[0.25em]" style={{ color: "var(--gold)" }}>
      ...
      <section className="relative overflow-hidden bg-[var(--ink)] py-24 text-center text-white">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <h2 className="mt-6 font-serif text-4xl md:text-5xl">Travel, refined to the last detail.</h2>
          <span className="gold-divider mx-auto mt-8" />
